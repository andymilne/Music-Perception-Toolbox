function ipval = innerProductDirectAbsSA(p_x, w_x, p_y, w_y, sigma, r, ...
                                            isPer, period)
%MOBIUS.INNERPRODUCTDIRECTABSSA  Direct-enumeration SA IP, abs mode.
%
%   IPVAL = MOBIUS.INNERPRODUCTDIRECTABSSA(P_X, W_X, P_Y, W_Y, SIGMA, R,
%                                            IS_PER, PERIOD)
...
%
%   See also MOBIUS.ORBITINNERABSSA, MOBIUS.MAPERATTRINNERMATRIX.
