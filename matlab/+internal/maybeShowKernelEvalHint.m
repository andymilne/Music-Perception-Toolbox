...
%
%   Called by evalMaet (centres path) and simMaet (Bulger
...
%   See also: MPTDEFAULTS.
    ...
    fprintf([ ...
        ...
        '\n' ...
        'Affects functions that build a kernel matrix: evalMaet,\n' ...
        'entropyMaet (Shannon), spectralEntropy, templateHarmonicity,\n' ...
        'virtualPitches, tensorHarmonicity (via evalMaet), and\n' ...
        'simMaet when routed to Bulger''s method. Also honoured by\n' ...
        'the Möbius relative-mode evaluator, where it additionally sets\n' ...
        'the factored strategy''s read-back accuracy target. Does not\n' ...
        'affect the Möbius inner-product path (simMaet at default\n' ...
        'workloads, entropyMaet with ''renyi2'').\n' ...
        '\n' ...
