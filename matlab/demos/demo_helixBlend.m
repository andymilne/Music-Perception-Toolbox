...
%   no baseline for it would be honest.
    ...
    specs = {struct('name', 'pitch class',  'r', 1, 'rel', false, ...
                    'exch', true, 'sigma', sigma_pc,   'isPer', true, ...
                    'period', 1200), ...
             struct('name', 'pitch height', 'r', 1, 'rel', false, ...
                    'exch', true, 'sigma', NaN,        'isPer', false, ...
                    'period', 0), ...
             struct('name', 'time',         'r', 1, 'rel', false, ...
                    'exch', true, 'sigma', sigma_time, 'isPer', false, ...
                    'period', 0)};
    pm = packPreMaet({p, p, t}, {ones(1, n), ones(1, n), ones(1, n)}, specs);
end
