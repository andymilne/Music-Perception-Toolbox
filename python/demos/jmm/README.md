...
| `demo_jmm_1_3_tonic_tuple_size.py` | Analysis 1.3 | How does raising the tuple size sharpen chord matching, across absolute/relative and periodic/non-periodic readings? | `build_maet`, `sim_maet` |
...
| `demo_jmm_3_1_diff.py` | Analysis 3.1 | Does joint differencing of pitch and time expose the accelerandi of the phasing voice at the timing JND? | `difference_events`, `build_maet`, `eval_maet`, windowed Rényi-2 entropy |
