...
%   See also buildExpTens, evalExpTens, cosSimExpTens, windowedTensorSimilarity.
    ...
    if internal.densityHasKernelCov(dens)
        error('mpt:aniso:windowTensor', ...
            ['windowTensor does not support densities built with a ' ...
             'matrix-valued kernel covariance: their stored ' ...
             'coordinates are whitened, so a window specified in the ' ...
             'attribute''s original coordinates would be applied in ' ...
             'the wrong frame. Use windowedSimilarity or ' ...
             'windowedEntropy, whose windows reweight the raw events ' ...
             'before the density is built.']);
    end
