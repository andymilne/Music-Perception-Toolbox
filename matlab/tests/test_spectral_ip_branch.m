...
for r = 2:4
    for K = [6, 10]
        ...
        for sop = [0.02, 0.05, 0.20]
            ...
            aOn  = simMaet(p, w, q, w, sigma, r, true, true, 1200, ...
                                 'method', 'mobius', 'verbose', false);
            internal.spectralIpEnabled(false);
            aOff = simMaet(p, w, q, w, sigma, r, true, true, 1200, ...
                                 'method', 'mobius', 'verbose', false);
            internal.spectralIpEnabled(true);
...
% simMaet (it fired only where the Moebius result was already
    ...
    for r = 2:4
        for K = [4, 6, 8, 12]
            ...
            for sigma = [0.1, 0.5, 2.0, 6.0, 15.0]
                ...
                w_ = ones(K, 1);
                cm = simMaet(p_, w_, q_, w_, sigma, r, isRelC, ...
                                   true, 1200, 'method', 'mobius', ...
                                   'verbose', false);
                cb = simMaet(p_, w_, q_, w_, sigma, r, isRelC, ...
