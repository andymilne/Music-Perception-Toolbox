...
%   (S, A, T, B) voicing: K = 4 per event, [exch] = 0 (ordered), r = 4.
...
%
%   See also JMM.BUILDSIMPLEXVOICE, JMM.BUILDVOICEAGNOSTIC, BUILDMAET.
    ...
    dens = buildMaet( ...
        ...
        [1200.0, 0.0], ...           % period
        [false, false], ...          % isExch = 0 -> ordered (voice-aware)
        'verbose', false);
end
