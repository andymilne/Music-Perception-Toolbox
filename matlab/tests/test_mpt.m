...
% Test-only reference implementations (the +reference package).
...
core = {'test_transform_attributes.m', 'test_score.m', 'test_add_spectra.m', 'test_circular.m'};
...
expTens = {'test_maet_core.m', 'test_entropy.m', 'test_dft_montecarlo.m', ...
           'test_sigma_space.m'};
...
v22 = {'test_mobius_combinatorics.m', 'test_mobius_orbit_table.m', ...
       ...
       'test_orbit_sparse.m', ...
       'test_dispatch_sm_cossim.m', 'test_dispatch_sm_eval.m', ...
       'test_dispatch_ma_cossim.m', 'test_dispatch_oom_guard.m', ...
       'test_dispatch_msg_throttle.m', ...
       'test_eval_ma_orbit.m', 'test_ma_eval_cost_model.m', ...
       'test_ma_eval_dispatch.m', 'test_ma_factored.m', ...
       'test_unequal_k_rel.m', ...
       ...
       'test_dispatch_scope.m', 'test_aniso_kernel_cov.m', ...
       'test_explain_dispatch.m', ...
       'test_rect_window_and_renyi2_degenerate.m', ...
       'test_post_hoc_guards.m', ...
       'test_self_ip_cache.m', 'test_self_ip_memo_sharing.m', 'test_routing_parity_fixes.m', ...
       'test_routing_parity_round1.m', 'test_routing_parity_round2.m', ...
       'test_routing_parity_round3.m', 'test_method_parity.m', ...
       'test_maet_centres.m', 'test_batched_shape_rule.m', ...
       'test_bucket_padding.m', 'test_periodic_cull.m'};
