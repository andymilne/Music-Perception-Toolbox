...
def test_eval_mobius_on_a_nested_density_takes_the_per_level_route():
    """A forced ``method='mobius'`` on a nested density once evaluated the
    flattened multiset silently (8.67 against 3.78 for the centres route
