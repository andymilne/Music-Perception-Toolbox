...
%
%   See also: fSetRoughness histEntropy
...
if nargin < 8
    if isPer == 1
        ...
        error(['When isPer = 0, the "limits" argument must be a 2-entry ' ...
               ...
               'it is advisable to ensure that no pitches exceed the ' ...
               'specified limits, and "limits" is the same over all ' ...
               'comparisons. For reference, if middle-C is 0 cents, ' ...
               'the audible range is [-4451, 7508]; if middle-C is 6000 ' ...
               'cents, the audible range is [1549, 13508].'])
    end
end
if nargin < 7
