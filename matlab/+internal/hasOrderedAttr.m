...
%HASORDEREDATTR  True if any flat attribute is ordered ([exch] = 0) at r > 1.
%
...
%   the same one computed faster. r = 1 is exempt ([exch] is vacuous at a
...
%   See also INTERNAL.SELECTMAEVAL, MOBIUS.EVALMAORBIT.
    ...
    if numel(isExch) == 1 && A > 1
        isExch = repmat(isExch, 1, A);
    end
