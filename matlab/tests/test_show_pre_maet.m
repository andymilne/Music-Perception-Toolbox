...
P = [36; 55; 60; 64];
oExch = showPreMaet({P}, [], {struct('r',2,'rel',false,'exch',true)}, ...
                   'names', {'pitch'}, 'sigma', 0.15, 'verbose', false);
oOrd = showPreMaet({P}, [], {struct('r',2,'rel',false,'exch',false)}, ...
                   'names', {'pitch'}, 'sigma', 0.15, 'verbose', false);
results{end+1,1} = 'showPreMaet: unordered braces, ordered parens'; %#ok<SAGROW>
results{end,2}   = ~isempty(strfind(oExch, '{36, 55, 60, 64}')) && ...
...
o = showPreMaet({[60 60; 64 64; 67 NaN]}, [], ...
                {struct('r',1,'rel',false,'exch',true)}, ...
...
o = showPreMaet({1, 2}, [], ...
                {struct('r',1,'rel',false,'exch',true,'name','pitch'), ...
                 struct('r',1,'rel',false,'exch',true)}, ...
...
dens = buildMaet(pFrag, wFrag, [0.5 0.25], [1 1], [false false], ...
