...
% v2.2: single-multiset isRel + r=1 was a hard error in v2.0/v2.1; relaxed to a
...
results{end+1,1} = 'buildExpTens: single-multiset isRel + r=1 emits degenerate warning (was error in v2.1)';
