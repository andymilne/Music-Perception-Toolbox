...
dx = buildMaet({PxA, PxB}, {[]; []}, [50 50], [2 2], ...
    [false false], [false false], [0 0], 'verbose', false);
dy = buildMaet({PyA, PyB}, {[]; []}, [50 50], [2 2], ...
    [false false], [false false], [0 0], 'verbose', false);
...
s_sparse = simMaet(dx, dy, 'method', 'mobius', ...
...
s_dense = simMaet(dx, dy, 'method', 'mobius', ...
...
rp_w = ones(rp_K, 1);
rp_s6 = simMaet(rp_p1, rp_w, rp_p2, rp_w, rp_sig, 2, true, true, ...
    rp_P, 'method', 'mobius', 'truncationSigmas', 6, 'verbose', false);
rp_si = simMaet(rp_p1, rp_w, rp_p2, rp_w, rp_sig, 2, true, true, ...
