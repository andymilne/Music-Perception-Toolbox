...
%
%   Example:
%       d = buildMaet(p, w, 60, 3, true, true, 1200);
...
%   as simMaet's localCosSimMA does; the flat selector then
...
%   cost estimation. Twin of the Python explain._explain_cosine.
    ...
    if orderedAny
        ...
        % user asked for).
        chosen = 'bulger';
        decidedBy = 'ordered ([exch]=0) attribute (no orbit to collapse)';
