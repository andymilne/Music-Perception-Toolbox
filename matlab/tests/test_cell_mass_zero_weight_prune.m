...
%  entropyMaet.
%
%  The auto-prune mirrors the eval-path prune in evalMaet. Without
...
% entropyMaet raw MA signature:
%   (pCell, wCell, sigma, r, groups, isRel, isPer, period, ...
%    'method', M, 'base', b, ...)
t0 = tic;
H_auto_diff = entropyMaet(p_w, w_w, 10.0, 1, ...
...
H_manual_diff = entropyMaet(p_w_pruned, w_w_pruned, 10.0, 1, ...
    false, false, 0.0, 'method', 'differential', 'base', 2.0, ...
    'verbose', false);
...
H_auto_shan = entropyMaet(p_w, w_w, 10.0, 1, ...
    false, false, 0.0, 'method', 'shannon', 'base', 2.0, ...
    'nPointsPerDim', 2001, 'xMin', 3000.0, 'xMax', 13000.0, ...
    'verbose', false);
H_manual_shan = entropyMaet(p_w_pruned, w_w_pruned, 10.0, 1, ...
    false, false, 0.0, 'method', 'shannon', 'base', 2.0, ...
    'nPointsPerDim', 2001, 'xMin', 3000.0, 'xMax', 13000.0, ...
    'verbose', false);
