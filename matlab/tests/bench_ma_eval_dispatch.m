...
for gi = 1:numel(grid)
    ...
    [pred, ~] = internal.selectMaEval(dens, false);
...
fprintf(['\nIf mispicks are nonzero and consistent, adjust ' ...
         'MA_CENTRES_DOMINANCE in\ninternal/selectMaEval.m: raise it to ' ...
         'favour Möbius further, lower it to favour centres.\n' ...
         'The o/j column shows the op-count ratio at each cell; the ' ...
