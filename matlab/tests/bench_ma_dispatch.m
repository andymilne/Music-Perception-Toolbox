...
for mi = 1:numel(modes)
    ...
    for ci = 1:numel(md.cells)
        ...
        if tWarm > TIME_CAP
            ...
            tBul = internal.timeRepeated(@() simMaet(dx, dy, ...
        ...
        if skipMob
            ...
            try
                ...
                if tWarm > TIME_CAP
                    ...
                    tMob = internal.timeRepeated(@() simMaet( ...
        ...
        % that did not happen.
        tAuto = internal.timeRepeated(@() simMaet( ...
            dx, dy, 'verbose', false));
