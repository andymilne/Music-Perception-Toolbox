...
for nafi_wrapC = {'full-image', 'single-image'}
    ...
    for nafi_sop = [0.01 0.05 0.1 0.2 0.3]
        ...
        cC = simMaet(nafi_dens(1, nafi_sigma, nafi_wrap), ...
                           nafi_dens(2, nafi_sigma, nafi_wrap), ...
                           'method', 'contract', 'verbose', false);
        cB = simMaet(nafi_dens(1, nafi_sigma, nafi_wrap), ...
                           nafi_dens(2, nafi_sigma, nafi_wrap), ...
...
cFull = simMaet(nafi_dens(1, nafi_sigma, 'full-image'), ...
                      nafi_dens(2, nafi_sigma, 'full-image'), ...
                      'method', 'contract', 'verbose', false);
cSingle = simMaet(nafi_dens(1, nafi_sigma, 'single-image'), ...
